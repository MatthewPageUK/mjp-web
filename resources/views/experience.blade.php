        ...
        <div class="col-span-2">
            ...
            <div class="mb-8 text-lg grid grid-cols-3 items-center border border-zinc-700 rounded-lg bg-zinc-900 overflow-hidden p-4">
                <div class="flex items-center gap-4">
                    {{-- Previous experience --}}
                    @if ($this->previous)
                        <a href="{{ route('experience', $this->previous) }}" class="flex items-center leading-none" title="Previous work experience">
                ...
                <div class="flex items-center gap-4">
                    ...
                    {{-- Next experience --}}
                    @if ($this->next)
                        <a href="{{ route('experience', $this->next) }}" class="flex items-center leading-none" title="Next work experience">
