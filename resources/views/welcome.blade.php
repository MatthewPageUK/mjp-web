    ...
    <div class="grid grid-cols-6 lg:grid-cols-12 gap-4 lg:gap-16 lg:mt-16">
        ...
        <div class="col-span-6">
            ...
            {{-- <ul class="grid grid-cols-2 gap-4">
                ...
                <li class="bg-lime-400 text-center py-4 opacity-80 hover:scale-105 hover:font-bold hover:opacity-100 transition ease-in-out hover:transition-all">Guaranteed satisfaction</li>
                <li class="bg-green-400 text-center py-4 opacity-80 hover:scale-105 hover:font-bold hover:opacity-100 transition ease-in-out hover:transition-all">Accountability</li>
                ...
                {{-- <li class="bg-purple-400 text-center py-4">JavaScript</li> --}}
