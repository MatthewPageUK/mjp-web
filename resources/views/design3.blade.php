    ...
    >
        ...
        {{-- lg:flex lg:space-x-8 lg:items-center px-8 py-6 lg:pt-10 bg-zinc-800 text-white  shadow-lg --}}
            <div class="text-left p-4 mb-0">
                <a href="/" class="md:rotate-90 md:w-[400px] origin-bottom-left block text-4xl text-white">Matthew Page</a>
        ...
        <div class="">
            ...
            {{-- Main page --}}
            <main class="max-w-7xl md:ml-[150px] lg:ml-[420px] p-6 lg:p-8 text-white">
