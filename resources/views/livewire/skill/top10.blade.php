<div>
    ...
    <div>
        ...
        <div class="mt-2">
            ...
            @if ($this->skills->hasPages())
                <x-layout.pagination-dots :paginator="$this->skills" />
