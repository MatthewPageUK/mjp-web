...
<form class="mt-8 bg-secondary-400 p-8 rounded shadow-lg">
    ...
    @if ($this->mailError)
        <div class="min-h-[250px]">
            ...
            <p class="text-primary-700 mb-4 ml-16">Sorry {{ $this->message['first_name'] }}, there was an error sending your message. Please try again, or email me direct on XX@XXXX.com.</p>
    ...
    @else
        ...
        >
            <div class="min-h-[250px]">
                <div class="flex gap-4 items-center mb-8">
                    <x-icons.material class="text-6xl text-primary-800">forward_to_inbox</x-icons.material>
                    <h1 class="text-4xl font-bold text-primary-800 mb-2">Sending mail
        ...
        <div wire:loading.remove wire:target="send">
            ...
            <div class="flex">
                <div class="flex-1">
                    <h1 class="text-4xl font-bold text-primary-800 mb-2">Let's connect...</h1>
                    <p class="text-primary-700 mb-8">Reach out with your ideas and thoughts and maybe together we can create something awesome.</p>
                </div>
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-24 h-24 fill-secondary-500 text-primary-800">
        ...
        <div wire:loading.remove wire:target="send" class="relative z-0 w-full mb-6 group">
            <textarea name="message.message" wire:model="message.message"
                class="font-gochi h-full block py-2.5 px-0 w-full text-2xl text-primary-800 font-bold bg-transparent border-0 border-b-2 border-primary-800
                appearance-none focus:outline-none focus:ring-0 focus:border-primary-600 peer" placeholder=" " required ></textarea>
            <label for="message.message" class="peer-focus:font-medium absolute text-sm text-primary-800
                duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-primary-600
        ...
        <div class="justify-self-end" wire:loading.remove wire:target="send">
            <button wire:click.prevent="send" class="
                ...
                text-white bg-primary-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-lg px-5 py-2.5
                text-center ">
