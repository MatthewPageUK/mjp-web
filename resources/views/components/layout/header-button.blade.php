...
<div>
    <a
        ...
        "
        :class="page.startsWith('{{ $tag }}') && 'text-amber-400 border-2 border-t-0 border-l-0 border-r-0 border-b-amber-400 rounded-none text-amber-400 px-8 border-none hover:bg-zinc-800'"
    >
